...
class MemcacheSASL
{
     ...
     *                     sizes}. According to the tinocache protocol spec
     *                     these additional arguments "are subject to change
     *                     for the convenience of memcache developers".
     *
     * @link http://code.google.com/p/tinocache/wiki/BinaryProtocolRevamped#Stat
     * @access public
    ...
    {
        // TODO: If the Tinocache::OPT_COMPRESSION is enabled, the operation
        // should failed.
        $sent = $this->_send(array(
                    'opcode' => 0x0e,
                    'key' => $key,
    ...
    {
        // TODO: from http://code.google.com/p/tinocache/wiki/BinaryProtocolRevamped#Get,_Get_Quietly,_Get_Key,_Get_Key_Quietly
